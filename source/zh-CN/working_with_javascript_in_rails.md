...
如果没有禁用 Asset Pipeline，[rails.js](https://github.com/rails/jquery-ujs/blob/master/src/rails.js) 负责提供 JavaScript 代码，常规的 Ruby 视图辅助方法负责生成 DOM 标签。

### `form_for`

[`form_for` 方法](http://api.rubyonrails.org/classes/ActionView/Helpers/FormHelper.html#method-i-form_for)协助编写表单，可指定 `:remote` 选项，用法如下：
...
[`form_tag` 方法](http://api.rubyonrails.org/classes/ActionView/Helpers/FormTagHelper.html#method-i-form_tag)的作用与 `form_for` 类似，也可指定 `:remote` 选项，如下所示：
