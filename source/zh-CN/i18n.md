Rails Internationalization (I18n) API Rails应用国际化(I18n)API
=====================================
...
Ruby的I18n(国际化的缩写)Gem包已经被整合进Rails框架中(从Rails2.2开始)，它为用户提供了**将英语转换为特定的语言**简便方法，同时也为你的Rails应用提供**多语言支持**功能。
...
通常国际化的意思是将本地的格式，包括一些特使格式(比如日期，货币)转换成国际通用的格式。本地化是指将国际通用格式转换为本地格式。

So, in the process of _internationalizing_ your Rails application you have to:

所以，在国际化你的Rails应用过程中，你必须确保：


* Ensure you have support for i18n. 确认你的Rails应用加载了i18n包。
* Tell Rails where to find locale dictionaries. 告诉Rails到哪里去找本地化字典文件。
* Tell Rails how to set, preserve and switch locales.告诉Rails如何设置和选择本地化方式。

In the process of _localizing_ your application you'll probably want to do the following three things:
在本地化你的Rails应用过程中，你最好做如下三件事情：

* Replace or supplement Rails' default locale - e.g. date and time formats, month names, Active Record model names, etc.

替换你的Rails应用中的默认本地化文件，比如 日期，时间格式，月份名称 ，Active Record 模型名称等等。
* Abstract strings in your application into keyed dictionaries - e.g. flash messages, static text in your views, etc.
将你的应用中需要转换的字符串，提取到本地化字典中。比如Flash消息，视图中的静态文本等。

* Store the resulting dictionaries somewhere.
  备份本地化和国际化相关的字典文件。

This guide will walk you through the I18n API and contains a tutorial on how to internationalize a Rails application from the start.
本指南将会介绍I18n API的使用并包含一个从零开始本地化Rails应用的过程。
...
提示： I18n 框架为你的应用实现国际化/本地化提供了必要支持。也许你希望使用更多gem包来扩展你的翻译功能。访问[rails-i18n gem](https://github.com/svenfuchs/rails-i18n)获取更多信息。

How I18n in Ruby on Rails Works  I18n在Rails框架中是如何运作的
-------------------------------
